...
export type ResidentFieldProps = {
...
export const ResidentField = ({ field, onSignField, onUnsignField }: ResidentFieldProps) => {
  ...
  // Parse field meta based on field type
  const isDateField = field.type === FieldType.RESIDENT_DOB;
  const safeFieldMeta = isDateField
  ...
  /**
   * When the user clicks the sign button in the dialog where they enter the field value.
   */
