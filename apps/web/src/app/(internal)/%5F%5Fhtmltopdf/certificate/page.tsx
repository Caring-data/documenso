  ...
  return (
    <div className="print-provider pointer-events-none mx-auto max-w-screen-md print:mx-0 print:max-w-full print:p-0">
      <div className="border-brand border p-5 print:m-0 print:p-0">
        ...
        >
          <div className="mt-[49px] flex items-center justify-center">
            <h1 className="text-brand my-8 flex h-6 w-full flex-col justify-center text-2xl font-bold leading-4">
          ...
          <Card>
            <CardContent className="p-0">
              <Table className="border-collapse border-0" overflowHidden>
                <TableHeader className="text-brand text-xs font-semibold leading-4">
                  <TableRow>
                    <TableHead>{_(msg`Signer Events`)}</TableHead>
                    <TableHead>{_(msg`Timestamp`)}</TableHead>
                ...
                <TableBody className="print:text-xs">
                  {document.recipients.map((recipient, i) => {
                    ...
                    return (
                      <TableRow key={i} className="border-zinc-200 print:break-inside-avoid">
                        <TableCell
                          truncate={false}
                        ...
                        <TableCell truncate={false} className="w-[min-content] align-top">
                          {signature ? (
                            <>
                              <div
                                className="inline-block h-[73px] self-stretch rounded-md border border-zinc-200 bg-white p-1"
                                style={{
                                  boxShadow: `0px 0px 0px 4.88px rgba(122, 196, 85, 0.1),
                                            0px 0px 0px 1.22px rgba(122, 196, 85, 0.6),
                                            0px 0px 0px 0.61px rgba(122, 196, 85, 1)`,
                                }}
                              >
                              ...
                              <p className="text-muted-foreground mt-2 text-sm print:text-xs">
                                ...
                                <span className="inline-block text-[10px] font-normal text-zinc-600">
