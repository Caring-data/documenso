...
export const FRIENDLY_FIELD_TYPE: Record<FieldType, MessageDescriptor> = {
  ...
  [FieldType.RESIDENT_LOCATION_NAME]: msg`L. Name`,
  [FieldType.RESIDENT_LOCATION_STATE]: msg`L. State`,
  [FieldType.RESIDENT_LOCATION_ADDRESS]: msg`L. Address`,
  [FieldType.RESIDENT_LOCATION_CITY]: msg`L. City`,
  [FieldType.RESIDENT_LOCATION_ZIP_CODE]: msg`L. Zip Code`,
  [FieldType.RESIDENT_LOCATION_COUNTRY]: msg`L. Country`,
  [FieldType.RESIDENT_LOCATION_FAX]: msg`L. Fax`,
  [FieldType.RESIDENT_LOCATION_LICENSING]: msg`L. Licensing`,
  [FieldType.RESIDENT_LOCATION_LICENSING_NAME]: msg`L. Licensee Name`,
  [FieldType.RESIDENT_LOCATION_ADMINISTRATOR_NAME]: msg`L. Admin Name`,
  [FieldType.RESIDENT_LOCATION_ADMINISTRATOR_PHONE]: msg`L. Admin Phone`,
};
